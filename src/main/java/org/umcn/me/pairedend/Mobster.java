...
public final class Mobster {
    ...
    public static void printUsage() {
        ...
        System.out.println("\t-np [normal predictions file]\tThis value will override the corresponding value in the properties file. Used for normal/tumor paired samples. The normal predictions in a .vcf or .txt file generated previously by Mobsters will be substracted from the tumor calls here.");
        System.out.println("\t-ns [normal sample name]\t\tThis value will override the corresponding value in the properties file. Can be used instead of '-np' to perform combined tumor/normal calling on paired samples using multisample calling. ");
        System.out.println("\t\t\t\t\t\t\t\t\tA normal and tumor sample should be provided to '-in' and '-sn'. The normal sample name must match a sample name given by '-sn'. Both will be used simultaneously to predict germline and somatic insertions.");
